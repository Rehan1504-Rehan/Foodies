    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('CUSTOMER', 'Customer'), ('RESTAURANT_OWNER', 'Restaurant Owner'), ('DELIVERY_BOY', 'Delivery Boy'), ('ADMIN', 'Admin')], db_index=True, default='CUSTOMER', max_length=20)),
